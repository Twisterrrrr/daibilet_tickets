...
async function main() {
  ...
  const collections = [
    ...
    },
    {
      slug: 'salyut',
      title: 'Салют с воды',
      subtitle: 'Речные прогулки с салютом и фейерверками',
      ...
      description: `Салют с воды — это особый опыт: фейерверк над рекой, подсвеченные мосты и набережные, романтика праздника.\n\nМы собрали речные прогулки с салютом и фейерверками в разных городах России: от Дня Победы до Дня города и новогодних праздников.`,
      metaTitle: 'Салют с воды — речные прогулки с фейерверками | Дайбилет',
      metaDescription:
        'Речные прогулки с салютом и фейерверками. Билеты на теплоходы с салютом в Санкт-Петербурге, Москве и других городах.',
      faq: [
        {
          question: 'Когда бывают прогулки с салютом?',
          answer:
            'В День Победы (9 мая), День города, Новый год и другие праздники. Расписание уточняйте в карточке события.',
        },
        {
          question: 'Можно ли заказать салют для своего праздника?',
          answer:
            'Некоторые теплоходы предлагают приватные прогулки с салютом. Уточняйте в описании события.',
        },
      ],
      infoBlocks: [],
      sortOrder: 3,
