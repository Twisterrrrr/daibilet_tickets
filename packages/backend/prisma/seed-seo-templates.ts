...
Цены: от {{price_from}} до {{price_to}} ₽. После оплаты вы получите электронное подтверждение. {{season_hint}}`,
  ...
  // === MUSEUMS (venues) ===
  {
    ...
    h1Tpl: 'Музеи в {{city}}',
    descriptionTpl:
      '{{count}} музеев и выставок в {{city}}: расписание, цены, электронные билеты и варианты посещения.',
...
Цены: от {{price_from}} до {{price_to}} ₽. Онлайн-оплата и электронное подтверждение покупки. {{season_hint}}`,
  },
  {
    ...
    descriptionTpl:
      '{{count}} вариантов. Выберите дату, площадку и купите билет онлайн — подтверждение сразу после оплаты.',
