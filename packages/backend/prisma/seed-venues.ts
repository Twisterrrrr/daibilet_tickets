...
const VENUES: VenueSeed[] = [
  // ═══════════ САНКТ-ПЕТЕРБУРГ (14) ═══════════
  {
    ...
    faq: [
      { q: 'Можно ли вернуть билет?', a: 'Да, возврат возможен не позднее чем за 2 часа до визита.' },
      {
        ...
        a: 'Бесплатно для детей до 14 лет, студентов РФ. Первый четверг месяца — бесплатный вход.',
      },
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Восточное крыло Главного штаба — филиал Эрмитажа, посвящённый искусству XIX–XX веков. Коллекции импрессионистов и постимпрессионистов — Моне, Ренуар, Пикассо, Матисс, Гоген.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Крупнейшее в мире собрание русского искусства. Основная экспозиция в Михайловском дворце. Коллекция включает свыше 400 000 экспонатов — от икон XII века до современного искусства.',
    ...
    faq: [
      {
        q: 'Чем отличается от Эрмитажа?',
        a: 'Русский музей — это исключительно русское искусство, а Эрмитаж — мировое.',
      },
      {
        q: 'Какие филиалы входят?',
        a: 'Михайловский дворец, Корпус Бенуа, Строгановский дворец, Мраморный дворец, Михайловский замок.',
      },
    ],
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Частный музей во дворце Нарышкиных-Шуваловых на набережной Фонтанки. Главная коллекция — 9 императорских пасхальных яиц Фаберже и другие произведения декоративно-прикладного искусства.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Первый музей России, основанный Петром I в 1714 году. Расположен на Университетской набережной Васильевского острова. Этнографические коллекции и знаменитая анатомическая коллекция.',
  ...
  },
  {
    ...
    venueType: 'ART_SPACE',
    description:
      'Единственный в России музей уличного искусства, расположенный на территории действующего завода. Масштабные муралы, инсталляции и выставки уличных художников со всего мира.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Самый большой планетарий в мире, расположенный в здании бывшего газгольдера. Купол диаметром 37 метров, полнокупольные шоу, космические экспозиции и интерактивные программы.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Историческое ядро Санкт-Петербурга на Заячьем острове. Петропавловский собор — усыпальница императоров, музей истории города, тюрьма Трубецкого бастиона, пляж и потрясающие виды на Неву.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Музей, посвящённый обороне и блокаде Ленинграда в 1941–1944 годах. Документы, личные вещи, фотографии, дневники и предметы быта блокадников. Один из важнейших мемориальных музеев России.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Один из крупнейших железнодорожных музеев мира. Более 100 единиц подвижного состава, интерактивные экспозиции, макеты, симуляторы. Расположен в двух зданиях рядом с Балтийским вокзалом.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Крупнейший православный собор Санкт-Петербурга и одно из высочайших купольных сооружений мира. Действует как музей-памятник. Колоннада — одна из лучших смотровых площадок города.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Один из самых красивых храмов России, построенный на месте смертельного ранения Александра II. Потрясающий мозаичный интерьер общей площадью более 7000 кв. м.',
  ...
  // ═══════════ МОСКВА (11) ═══════════
  {
    ...
    venueType: 'GALLERY',
    description:
      'Национальный музей русского изобразительного искусства X–XXI веков. Основная экспозиция в Лаврушинском переулке: иконы, живопись, скульптура — от Рублёва до Врубеля.',
    ...
    faq: [
      {
        q: 'Чем отличается от Новой Третьяковки?',
        a: 'Основная Третьяковка — классическое русское искусство (иконы, XIX век). Новая — XX–XXI век (авангард, соцреализм, современность).',
      },
  ...
  },
  {
    ...
    venueType: 'GALLERY',
    description:
      'Филиал Третьяковской галереи на Крымском Валу. Искусство XX–XXI веков: авангард, соцреализм, нонконформизм, современное искусство. Масштабные временные выставки.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Один из крупнейших российских музеев зарубежного искусства. Египетские древности, античная скульптура, средневековое искусство, живопись старых мастеров, импрессионисты.',
  ...
  },
  {
    ...
    venueType: 'ART_SPACE',
    description:
      'Один из важнейших центров современной культуры в Москве, расположенный в Парке Горького. Выставки, образовательные программы, архив, книжный магазин.',
  ...
  },
  {
    ...
    venueType: 'ART_SPACE',
    description:
      'Музей, посвящённый фотографии, мультимедийному и современному искусству. Расположен на Остоженке. Регулярные выставки российских и международных художников.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Один из старейших планетариев мира, открытый в 1929 году. Большой звёздный зал, интерактивный музей «Лунариум», обсерватория и кинотеатр 4D.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Один из крупнейших научно-технических музеев мира. Расположен в цоколе монумента «Покорителям космоса» на ВДНХ. Космические аппараты, скафандры, тренажёры.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Крупнейший национальный исторический музей России, расположенный на Красной площади. Коллекция: от палеолита до XX века, более 5 миллионов предметов.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Государственный историко-культурный музей-заповедник. Оружейная палата, Алмазный фонд, Успенский собор, колокольня Ивана Великого и другие музеи на территории Кремля.',
  ...
  },
  {
    ...
    venueType: 'ART_SPACE',
    description:
      'Культурный центр фонда V-A-C в здании бывшей электростанции на Болотной набережной. Выставки, перформансы, кинопоказы, лекции. Архитектор реконструкции — Ренцо Пьяно.',
  ...
  // ═══════════ КАЗАНЬ (5) ═══════════
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Древняя крепость и объект ЮНЕСКО. На территории: мечеть Кул-Шариф, Благовещенский собор, башня Сююмбике, музеи. Символ слияния восточной и западной культур.',
    ...
    faq: [
      ...
      {
        q: 'Можно ли зайти в мечеть?',
        a: 'Да, Кул-Шариф открыта для посещения. Соблюдайте дресс-код: закрытые плечи и колени.',
      },
    ],
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Расположен в цокольном этаже мечети Кул-Шариф. Экспозиции о роли ислама в истории Поволжья, коллекция Коранов, каллиграфия, предметы быта мусульман.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Старейший и крупнейший музей Татарстана. Коллекции по истории, археологии, этнографии края — от булгарского периода до наших дней. Более 800 000 экспонатов.',
  ...
  },
  {
    ...
    venueType: 'GALLERY',
    description:
      'Филиал Государственного музея изобразительных искусств РТ, посвящённый современному искусству. Выставки российских и международных художников в современном пространстве.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Интерактивный музей, посвящённый главному татарскому лакомству. Экскурсии с дегустацией, мастер-классы по приготовлению чак-чака, история татарской кухни в уютной обстановке.',
  ...
  // ═══════════ КАЛИНИНГРАД (4) ═══════════
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Единственный в России комплексный маринистический музей. Подводная лодка Б-413, научно-исследовательское судно «Витязь», экспозиции по океанологии, морской геологии и экологии.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Расположен в фортификационной башне Дона у озера Верхнего. Единственный в России музей одного минерала. Коллекция янтаря от древних включений до современных ювелирных шедевров.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Готический собор XIV века на острове Канта (Кнайпхоф). Могила Иммануила Канта, музей собора, органный зал с регулярными концертами. Символ Калининграда.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Музей в одних из сохранившихся городских ворот Кёнигсберга. Экспозиции об истории города, его жителях и повседневной жизни. Мультимедийная «прогулка по улицам старого Кёнигсберга».',
  ...
  // ═══════════ ВЛАДИМИР (3) ═══════════
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Белокаменный собор XII века — объект ЮНЕСКО. Послужил образцом для Успенского собора Московского Кремля. Сохранились фрески Андрея Рублёва (XV век).',
    ...
    citySlug: 'vladimir',
    highlights: ['Объект ЮНЕСКО (XII век)', 'Фрески Андрея Рублёва', 'Прообраз Успенского собора Кремля'],
    features: ['audio_guide', 'photo_allowed'],
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Памятник древнерусской архитектуры XII века — единственные сохранившиеся городские ворота Древней Руси. Внутри — музей-диорама «Штурм Владимира ордами Батыя».',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Музейный комплекс во Владимире, объединяющий экспозиции по истории Владимирского края, детский музейный центр, картинную галерею и выставочные залы.',
  ...
  // ═══════════ ЯРОСЛАВЛЬ (3) ═══════════
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Крупнейший музей Ярославля в стенах Спасо-Преображенского монастыря XVI века. Здесь нашли «Слово о полку Игореве». Смотровая площадка, иконы, фрески, коллекция древнерусского искусства.',
    ...
    citySlug: 'yaroslavl',
    highlights: ['Место находки «Слова о полку Игореве»', 'Смотровая площадка на звоннице', 'Фрески XVI века'],
  ...
  },
  {
    ...
    venueType: 'GALLERY',
    description:
      'Крупнейшая коллекция русского искусства в провинции. Более 75 000 произведений: иконы XIII–XX веков, живопись, графика, скульптура. Расположен в Губернаторском доме на Волге.',
  ...
  },
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Современный планетарий с космическим музеем, обсерваторией и кинотеатром. Полнокупольные программы, интерактивные экспозиции о космосе. Назван в честь первой женщины-космонавта.',
  ...
  // ═══════════ НИЖНИЙ НОВГОРОД (3) ═══════════
  {
    ...
    venueType: 'MUSEUM',
    description:
      'Крепость XVI века на слиянии Оки и Волги. 13 башен, прогулка по стенам с видом на Стрелку, экспозиция военной техники, музеи и выставки. Главная достопримечательность города.',
  ...
  },
  {
    ...
    venueType: 'ART_SPACE',
    description:
      'Филиал ГЦСИ в Нижегородском Кремле. Выставки современного российского и международного искусства, лекции, кинопоказы, перформансы. Одна из ведущих арт-площадок Поволжья.',
  ...
  },
  {
    ...
    venueType: 'GALLERY',
    description:
      'Один из старейших художественных музеев России (с 1896 года). Русское искусство от икон до авангарда, коллекция западноевропейского искусства. Две площадки: Кремль и Верхне-Волжская набережная.',
