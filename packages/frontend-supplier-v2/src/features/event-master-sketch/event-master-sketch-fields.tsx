    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <select
          ...
          aria-disabled
          className={cn(
            'flex h-10 w-full min-h-[var(--control-height)] appearance-none rounded-control border border-border-soft bg-surface px-3 pr-9 text-body text-text-primary opacity-90',
