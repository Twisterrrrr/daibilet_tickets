...
import { Badge, Button, SectionTitle, Surface } from '@/features/event-master-sketch/sketch-primitives';
            ...
            <div className="rounded-control border border-border-soft bg-surface-alt/50 p-3">
              ...
              <div className="mt-3 space-y-2">
                <label className="flex cursor-pointer items-start gap-2">
                  <input
                    type="radio"
                    name="ticket-quota-sketch-supplier"
                ...
                <label className="flex cursor-pointer flex-wrap items-center gap-x-2 gap-y-2">
                  ...
                  <input
                    ...
                    className={cn(inputClass, 'w-[5.5rem] py-1 tabular-nums disabled:opacity-45')}
                  />
