...
/** Роль из access JWT (только UI; авторитет — backend guards). */
...
/**
 * Скрываем пункты бокового меню, по которым типичный запрос даст 403 для данной роли.
 * См. docs/RBAC-Matrix.md, docs/Security-Test-Matrix.md.
 */
