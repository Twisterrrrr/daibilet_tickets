...
export const metadata: Metadata = {
  title: 'Статьи — гиды и советы путешественникам | Дайбилет',
  description:
    'Полезные материалы о лучших экскурсиях, маршрутах и мероприятиях. Перелинковка с каталогом событий Дайбилет.',
};
    ...
    <>
      <section className="bg-gradient-to-br from-slate-800 to-slate-900 py-16">
        <div className="container-page">
          ...
          <h1 className="mt-3 text-4xl font-extrabold text-white sm:text-5xl">Статьи</h1>
          <p className="mt-4 max-w-2xl text-lg text-slate-300">
            SEO-материалы, гиды по городам и перелинковка с каталогом — без дублирования витрины
          </p>
        </div>
      </section>
            ...
            {articles.items.map((article) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <h2 className="mt-2 line-clamp-2 text-lg font-bold text-slate-900 group-hover:text-primary-600">
                    {article.title}
                  </h2>

                  {article.excerpt && (
                    <p className="mt-2 flex-1 line-clamp-3 text-sm text-slate-500">{article.excerpt}</p>
                  )}
