          ...
          <div className="space-y-3">
            ...
            {value.tiers.length === 0 && (
              <p className="text-xs text-slate-500">
                Пока нет ни одного типа билета. Добавьте хотя бы один для создания первого оффера при создании события,
                или оставьте пустым — событие будет создано без оффера, способы покупки можно настроить позже в
                карточке.
              </p>
            )}
          </div>
